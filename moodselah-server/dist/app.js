...
var decodeJWT_1 = __importDefault(require("./helpers/decodeJWT"));
...
var App = /** @class */ (function () {
    function App() {
        ...
        this.registerStaticPath = function () {
            _this.app.express.use("/images", express_1.default.static(path_1.default.resolve(__dirname, UPLOAD_FILE_PATH)));
            _this.app.express.use(express_1.default.static(path_1.default.resolve(__dirname, "../../moodselah-client", "build-current")));
        };
        this.registerCustomRoutes = function () {
            _this.app.express.get("*", function (req, res) {
                return res.sendFile(path_1.default.resolve(__dirname, "../../moodselah-client", "build-current", "index.html"));
            });
        };
        this.registerErrorHandles = function () {
            _this.app.express.use(error_middleware_1.default);
        };
